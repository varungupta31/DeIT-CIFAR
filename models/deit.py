...
class DataEfficientImageTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.cls_head = nn.Linear(embed_dim, 100, bias=True)
        self.dist_head = nn.Linear(embed_dim, 100, bias=True)
    ...
    def forward(self, x):
        ...
        x = self.cls_head(cls_token_final)
        y = self.dist_head(dist_token_final)
